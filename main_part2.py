...
def generate_user_flows():
    """
    Generates a fully dynamic list of random user flows (150-250) for Mweb traffic.
...
def print_distribution_summary(pool):
    ...
    print("\n==================================================")
    print("   DAILY MWEB TRAFFIC DISTRIBUTION SUMMARY")
    print("==================================================")
    print(f"Total Mweb Bots Generated: {total}")
...
def main():
    print("==================================================")
    print("   SINGITRONIC TRAFFIC ENGINE: MWEB WRAPPER")
    print("==================================================\n")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for i in range(TOTAL_USERS):
                ...
                print(f"  -> Initiating Mweb Flow | Auth: {user_type} | Journey: {journey_name}")
               
                context = None
                try:
                    # Device Emulation Setup (Mobile iPhone 13)
                    context_kwargs = build_context_options()
                    iphone_device = p.devices['iPhone 13']
                    context_kwargs.update(iphone_device)
                    ...
                    analytics_monitor = AnalyticsMonitor(f"Mweb Session #{user_id}")
                    ...
                    wait_for_analytics_flush(page, f"Mweb Session #{user_id}")
                    time.sleep(3.0)
            ...
            print("\n==================================================")
            print(f"   SUCCESS: ALL {TOTAL_USERS} MWEB BOTS COMPLETED")
